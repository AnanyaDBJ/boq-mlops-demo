...
Opening a pull request will trigger a[workflow](../.github/workflows/boq_mlops_project-run-tests.yml) 
...
Links:
* [Staging model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/staging/boq_mlops_project/boq_mlops_project-model)
* [Prod model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/prod/boq_mlops_project/boq_mlops_project-model)
. 
