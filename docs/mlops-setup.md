...
git add README.md docs .gitignore boq_mlops_project/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[boq_mlops_project/databricks.yml](../boq_mlops_project/databricks.yml) file.
...
Follow the instructions in [boq_mlops_project/resources/README.md](../boq_mlops_project/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../boq_mlops_project/resources/README.md)  to propose, test, and deploy
